...
const ContainerSubscriptions = () => {
    const subscriptions = [
        ...
        },
        {
            ...
            description: 'Acceso limitado a contenido básico.',
            price: 2.99,
        },
        {
            id: 4,
            name: 'Mirgely Serrano',
            image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQebFNS54HwIBECWfd4B3T5mNEKfddSuagJK8iJl8gbFeyaVh0-SM-X05SOq5I1QQYr1tU&usqp=CAU', 
            description: 'Acceso limitado a contenido básico.',
            price: 2.99,
        },
        {
    ...
    return (
        <div className="container mx-1 my-8 p-8 bg-gray-100">
